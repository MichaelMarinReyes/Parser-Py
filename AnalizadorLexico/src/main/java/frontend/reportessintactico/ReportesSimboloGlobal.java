 ...
 * @author michael
 */
public class ReportesSimboloGlobal extends javax.swing.JPanel implements MouseListener {
    ...
    public void actualizarTabla() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"No.", "Nombre", "Línea", "Columna"}, EditorPanel.listaToken.size());
